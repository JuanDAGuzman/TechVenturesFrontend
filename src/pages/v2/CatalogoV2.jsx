          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              ...
              {bundleDeals.map((deal) => {
                ...
                const savingPct = minPrice > 0 ? Math.round((savingUnit / minPrice) * 100) : 0;
                  ...
                  <div key={deal.id}
                    ...
                    <div className="px-4 pt-4 pb-3 flex items-start gap-4">
                        ...
                        <div className="shrink-0 flex flex-col items-center gap-1 pt-0.5">
                          <div className="flex -space-x-3">
                            {dealProducts.slice(0, 4).map((p, i) => (
                              <div key={p.id}
                                className="w-11 h-11 rounded-xl overflow-hidden bg-slate-50 border-2 border-white flex items-center justify-center shadow-sm"
                                style={{ zIndex: 4 - i }}>
                                {p.image_url
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-bold text-slate-800 text-sm leading-tight">{deal.match_name}</p>
                        {dealProducts.length > 0 && (
